...
ggsave("outputs/lambda1_vs_Rt.png", p_combined, width = 10, height = 6, dpi = 150)
cat("Plot saved to outputs/lambda1_vs_Rt.png\n")
...
saveRDS(dat, "data-processed/harmonised_daily.rds")
write_csv(dat, "data-processed/harmonised_daily.csv")
cat("Saved to data-processed/harmonised_daily.rds and .csv\n")
...
ggsave("outputs/harmonised_daily_overview.png", p_overview,
       width = 10, height = 8, dpi = 150)
cat("Plot saved to outputs/harmonised_daily_overview.png\n")
...
ggsave("outputs/fit_baseline_glm_vs_gam.png", p_fit,
       width = 10, height = 4, dpi = 150)
cat("Plot saved to outputs/fit_baseline_glm_vs_gam.png\n")

# 7. Save model objects
saveRDS(fit_baseline_glm, "data-processed/fit_baseline_glm.rds")
saveRDS(fit_baseline_gam, "data-processed/fit_baseline_gam.rds")
cat("Models saved.\n")
