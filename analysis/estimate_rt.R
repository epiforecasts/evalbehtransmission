# Estimates time-varying Rt from inc2prev-derived incidence using EpiEstim
# (parametric serial interval, 7-day sliding window).
...
# Load incidence ---
ons_incidence <- read_csv("data-processed/incidence_national.csv") |>
  arrange(date)
...
write_csv(rt_estimates, "data-processed/rt_estimates_England.csv")
